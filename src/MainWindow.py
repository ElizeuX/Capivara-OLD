...
class MainWindow(Gtk.ApplicationWindow):
    ...
    voCharacter = namedtuple('voCharacter',
                             ['name', 'archtype', 'date_of_birth', 'age', 'sex', 'height', 'weight', 'body_type',
                              ...
                              'background','picture', 'biography', 'relationships'])
    ...
    def __init__(self, **kwargs):
        ...
        if not self.info_bar.get_revealed() and newVersion:
            self.lblInfoBar.set_text("Um nova versão do Capivara está disponível!")
        ...
        if response == Gtk.ResponseType.OK:
            ...
            try:
                ...
                vo = self.voCharacter(self.txtName, self.cboArchtype, self.txtDate, self.txtAge, self.cboSex,
                                      ...
                                      self.txtTag, self.txtLocal, self.txtFace, self.txtMouth, self.txtImperfections, self.txtBackground, self.imgCharacter,
                                      self.list_store, self.lstStoreMap)
    ...
    def on_btn_new_project_clicked(self, widget):
        ...
        vo = self.voCharacter(self.txtName, self.cboArchtype, self.txtDate, self.txtAge, self.cboSex, self.txtHeigth,
                              ...
                              self.txtArms,self.txtLegs, self.txtTag, self.txtLocal,
                              self.txtFace, self.txtMouth, self.txtImperfections, self.txtBackground, self.imgCharacter,
                              self.list_store, self.lstStoreMap)
