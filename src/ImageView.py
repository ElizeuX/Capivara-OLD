...
class ImageViewDialog(Gtk.Dialog):

    image = Gtk.Template.Child(name='gtkImage')
    ...
    def __init__(self, parent):
        ...
        pixbuf = GdkPixbuf.Pixbuf.new_from_file_at_scale(
            filename="assets/icons/icon.png",
            width=240,
            height=204,
        ...
        # pixbuf = self.get_pixbuf_from_base64string(__NOIMAGE)
        # pixbuf = pixbuf.scale_simple(170, 200, 2)
        # self.image.set_from_pixbuf(pixbuf)


        # pixbuf = Pixbuf.new_from_file("C:/Users/Elizeu/OneDrive - PRODESP/Pictures/Fotos Larinha/DSC_0861.JPG")
    ...
    def update_image(self):
        ...
        # ## add a new image
        # pixbuf = Pixbuf.new_from_file_at_scale(
        #     filename="/Users/Elizeu/OneDrive - PRODESP/Pictures/Fotos Larinha/DSC_0861.JPG",
        #     width=300,
        #     height=300,
        #     preserve_aspect_ratio=True)
        #
        # image = Gtk.Image()
        # pixbuf = pixbuf.scale_simple(370, 300, 2)
        # # image.set_from_file('C:/Users/Elizeu/OneDrive - PRODESP/Pictures/Fotos Larinha/DSC_0861.JPG')
        # image = Gtk.Image.new_from_pixbuf(pixbuf)
        # image.set_pixel_size(50)
        # self.image_area.add(image)
        # self.image_area.show_all()

    def get_pixbuf_from_base64string(self, base64string):
