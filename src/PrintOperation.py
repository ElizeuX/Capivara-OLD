...
class PrintOperation(Gtk.Window):
    ...
    def __init__(self, id=None):
        ...
        text = text + '<b>Nome:</b>' + c.name + '\n'
        text = text + '<b>Arquétipo:</b>' + c.archtype +'\n'
        text = text + '<b>Data de nascimento:</b>' + str(c.date_of_birth) + '<b>Sexo:</b>' + c.sex + '\n'
        text = text + '<b>Altura:</b>' + str(c.height) + '<b>Peso:</b>' + str(c.weight) + '<i>Kg</i>\n'
